      ...
      <div>
        ...
        >
          ...
          <div
            ...
            className={`group relative flex items-center justify-center hover:bg-gray-500/20 transition-all duration-200 h-9 w-9 aspect-square rounded-lg cursor-pointer`}
          >
        ...
        >
          <Image
            ...
            src={expand ? assets.chat_icon : assets.chat_icon}
            alt=""
          />
          <div className="absolute w-max -top-12 -right-12 opacity-0 group-hover:opacity-100 transition bg-black text-white text-sm px-3 py-2 rounded-lg shadow-lg pointer-events-none">
            New Chat
            <div className="w-3 h-3 absolutebg-black rotate-45 left-4 -bottom-1.5"></div>
          </div>
